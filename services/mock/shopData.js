...
const profileTools = [
  ...
  { key: "coupon", title: "优惠券", subtitle: "6 张可用优惠券" },
...
const serviceContent = {
  address: {
    title: "收货地址",
    desc: "当前为假数据展示页，后续可直接接入用户地址接口。",
    records: [
      { title: "张女士 13800001234", text: "上海市 徐汇区 田林路 388 号 2 栋 1201" },
      { title: "公司前台 021-55667788", text: "上海市 长宁区 临虹路 168 弄 5 号楼 1 层前台" }
    ]
  },
  coupon: {
    title: "优惠券",
    desc: "支持展示待使用、已使用和即将过期优惠券。",
    records: [
  ...
  support: {
    title: "客服与帮助",
    desc: "演示帮助中心，适合后续挂 FAQ、工单和在线客服入口。",
    records: [
      { title: "配送说明", text: "现货商品 48 小时内发货，生鲜次日达为演示文案" },
